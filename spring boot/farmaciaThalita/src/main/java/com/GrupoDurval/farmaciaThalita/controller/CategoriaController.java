...
import com.GrupoDurval.farmaciaThalita.repository.CategoriaRepository;
...
private @Autowired CategoriaRepository categoriaRepository;
	...
	public ResponseEntity<List<Categoria>> getByNome (@PathVariable String nome) {
		return ResponseEntity.status(HttpStatus.OK).body(categoriaRepository.findAllByNomeContainingIgnoreCase(nome));
